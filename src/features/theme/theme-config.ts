...
export const AI_DESCRIPTION =
  "chat.malling.no helt trygg å bruke. Start en ny samtale for å chatte, laste opp filer, generere og analysere bilder, eller utforske ulike personligheter og utvidelser.";
