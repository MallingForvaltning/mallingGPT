...
export const AI_DESCRIPTION =
  "Malling sin egen AI er helt trygg å bruke. Start en ny samtale for å chatte, laste opp filer, generere og analysere bilder, eller utforske ulike personligheter og utvidelser.";
